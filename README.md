...
The post implementation netlist is generated using VPR provinding following command:
...
The simulation is performed on VIVADO by providing the primitive.v file that contains primitives used in the implementation RVMyth i SOFA. The final simulated result waveform is shown below:
